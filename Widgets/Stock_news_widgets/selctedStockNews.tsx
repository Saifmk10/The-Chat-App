...
const SlectedStockNewsTemplate = () => {
    ...
    return (
        ...
        <LinearGradient colors={['#000000', '#372A8F']} locations={[0.02, 1]}  style={style.parentDesign}>
            ...
            {/* main content */}
            <View>
                <Text style={style.textDesignNewsContent}>Indian renewable energy solutions provider Suzlon Group has secured an order from ArcelorMittal for 248.85MW of wind energy through its renewable energy entity in the country.</Text>
            </View>
...
export default SlectedStockNewsTemplate